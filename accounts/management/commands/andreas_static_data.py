...
Ηλ. Ταχυδρομείο : pdede@sch.gr''',
    ...
    def load_leave_types(self):
        ...
        leave_types_data = [
            {'name': '1 Κανονική Άδεια', 'description': 'Κανονική Άδεια', 'max_days': 25, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση κανονικής άδειας', 'decision_text': 'κανονική άδεια', 'folder': 'Φ 12.1/', 'general_category': 'Κανονικές Άδειες', 'affects_regular_leave_balance': True},
            {'name': '2α Αναρρωτική Άδεια με ΥΔ', 'description': 'Αναρρωτική Άδεια με ΥΔ', 'max_days': 15, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False, 'is_sick_leave_yd': True, 'is_sick_leave_total': True},
            {'name': '2β Αναρρωτική Άδεια με Ιατρική Γνωμάτευση', 'description': 'Αναρρωτική Άδεια με Ιατρική Γνωμάτευση', 'max_days': 20, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False, 'is_sick_leave_total': True},
            {'name': '2γ Αναρρωτική Άδεια με απόφ. Υγειονομικής Επιτροπής', 'description': 'Αναρρωτική Άδεια με απόφ. Υγειονομικής Επιτροπής', 'max_days': 30, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False, 'is_sick_leave_total': True},
            {'name': '3 Άδεια αιμοδοσίας', 'description': 'Άδεια αιμοδοσίας', 'max_days': 2, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας αιμοδοσίας', 'decision_text': 'άδεια αιμοδοσίας', 'folder': 'Φ 12.4/', 'general_category': 'Άδειες Αιμοδοσίας', 'affects_regular_leave_balance': False},
            {'name': '4 Άδεια για την παρακολούθηση της σχολικής επίδοσης των τέκνων', 'description': 'Άδεια για την παρακολούθηση της σχολικής επίδοσης των τέκνων', 'max_days': 4, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας για την παρακολούθηση της σχολικής επίδοσης των τέκνων', 'decision_text': 'άδεια για την παρακολούθηση της σχολικής επίδοσης των τέκνων', 'folder': 'Φ 12.3/', 'general_category': 'Γονικές Άδειες', 'affects_regular_leave_balance': False},
            {'name': '5 Άδεια για επιμορφωτικούς ή επιστημονικούς λόγους', 'description': 'Άδεια για επιμορφωτικούς ή επιστημονικούς λόγους', 'max_days': 30, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας για επιμορφωτικούς ή επιστημονικούς λόγους', 'decision_text': 'άδεια για επιμορφωτικούς ή επιστημονικούς λόγους', 'folder': 'Φ 12.6/', 'general_category': 'Επιμορφωτικές Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια Αναπηρίας', 'description': 'Άδεια Αναπηρίας', 'max_days': 10, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας αναπηρίας', 'decision_text': 'άδεια αναπηρίας', 'folder': 'Φ.12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια Γάμου', 'description': 'Άδεια Γάμου', 'max_days': 5, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας γάμου', 'decision_text': 'άδεια γάμου', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια Γέννησης Τέκνου', 'description': 'Άδεια Γέννησης Τέκνου', 'max_days': 2, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας γέννησης τέκνου', 'decision_text': 'άδεια γέννησης τέκνου', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια άσκησης εκλογικού δικαιώματος', 'description': 'Άδεια άσκησης εκλογικού δικαιώματος', 'max_days': 1, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας άσκησης εκλογικού δικαιώματος', 'decision_text': 'άδεια άσκησης εκλογικού δικαιώματος', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια αιρετών ΟΤΑ Α\' & Β΄ βαθμού', 'description': 'Άδεια αιρετών ΟΤΑ Α\' & Β΄ βαθμού', 'max_days': 20, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας αιρετών ΟΤΑ Α\' & Β΄ βαθμού', 'decision_text': 'άδεια αιρετών ΟΤΑ Α\' & Β΄ βαθμού', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια αναπηρίας', 'description': 'Άδεια αναπηρίας', 'max_days': 10, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας αναπηρίας', 'decision_text': 'άδεια αναπηρίας', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια ανατροφής τέκνου', 'description': 'Άδεια ανατροφής τέκνου', 'max_days': 120, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Άδειας ανατροφής τέκνου', 'decision_text': 'άδεια ανατροφής τέκνου', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια ασθένειας τέκνων', 'description': 'Άδεια ασθένειας τέκνων', 'max_days': 14, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας ασθένειας τέκνων', 'decision_text': 'άδεια ασθένειας τέκνων', 'folder': 'Φ 12.2/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια για συμμετοχή σε δίκη', 'description': 'Άδεια για συμμετοχή σε δίκη', 'max_days': 2, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας για συμμετοχή σε δίκη', 'decision_text': 'άδεια για συμμετοχή σε δίκη', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια γυναικολογικού ελέγχου', 'description': 'Άδεια γυναικολογικού ελέγχου', 'max_days': 1, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας γυναικολογικού ελέγχου', 'decision_text': 'άδεια γυναικολογικού ελέγχου', 'folder': 'Φ.12.11/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια ειδικού σκοπού', 'description': 'Άδεια ειδικού σκοπού', 'max_days': 5, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας ειδικού σκοπού', 'decision_text': 'άδεια ειδικού σκοπου', 'folder': 'Φ.12.10/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια ειδικού σκοπού λόγω νόσησης τέκνου με κορωνοϊό COVID-19', 'description': 'Άδεια ειδικού σκοπού λόγω νόσησης τέκνου με κορωνοϊό COVID-19', 'max_days': 14, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας ειδικού σκοπού λόγω νόσησης τέκνου με κορωνοϊό COVID-19', 'decision_text': 'άδεια ειδικού σκοπού λόγω νόσησης τέκνου με κορωνοϊό COVID-19', 'folder': 'Φ 12.10/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια εξετάσεων', 'description': 'Άδεια εξετάσεων', 'max_days': 14, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας εξετάσεων', 'decision_text': 'άδεια εξετάσεων', 'folder': 'Φ 12.6/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια κύησης', 'description': 'Άδεια κύησης', 'max_days': 60, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας κύησης', 'decision_text': 'άδεια κύησης', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια λοχείας', 'description': 'Άδεια λοχείας', 'max_days': 60, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας λοχείας', 'decision_text': 'άδεια λοχείας', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια νοσήματος', 'description': 'Άδεια νοσήματος', 'max_days': 30, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας νοσήματος', 'decision_text': 'άδεια νοσήματος', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια νοσήματος τέκνου', 'description': 'Άδεια νοσήματος τέκνου', 'max_days': 30, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας νοσήματος τέκνου', 'decision_text': 'άδεια νοσήματος τέκνου', 'folder': 'Φ.12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια προγεννητικού ελέγχου', 'description': 'Άδεια προγεννητικού ελέγχου', 'max_days': 7, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας προγεννητικού ελέγχου', 'decision_text': 'άδεια προγεννητικού ελέγχου', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Άδεια χωρίς αποδοχές', 'description': 'Άδεια χωρίς αποδοχές', 'max_days': 365, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση άδειας χωρίς αποδοχές', 'decision_text': 'άδεια χωρίς αποδοχές', 'folder': 'Φ 12.8/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Αναρρωτική άδεια ειδικού σκοπού', 'description': 'Αναρρωτική άδεια ειδικού σκοπού', 'max_days': 10, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδεια ειδικού σκοπού', 'decision_text': 'αναρρωτική άδεια ειδικού σκοπού', 'folder': 'Φ.12.10/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False, 'is_sick_leave_total': True},
            {'name': 'Γονική Άδεια (Ν.4808/2021)', 'description': 'Γονική Άδεια (Ν.4808/2021)', 'max_days': 120, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Γονικής Άδειας (Ν.4808/2021)', 'decision_text': 'Γονική Άδεια (Ν.4808/2021)', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Ειδική άδεια ανυπαίτιου κωλύματος', 'description': 'Ειδική άδεια ανυπαίτιου κωλύματος', 'max_days': 5, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση ειδικής άδειας ανυπαίτιου κωλύματος', 'decision_text': 'ειδική άδεια ανυπαίτιου κωλύματος', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Ειδική άδεια απουσίας ομάδων αυξημένου κινδύνου', 'description': 'Ειδική άδεια απουσίας ομάδων αυξημένου κινδύνου', 'max_days': 30, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση ειδικής άδειας απουσίας ομάδων αυξημένου κινδύνου', 'decision_text': 'ειδική άδεια απουσίας ομάδων αυξημένου κινδύνου', 'folder': 'Φ.12.11/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Ειδική άδεια διευκόλυνσης', 'description': 'Ειδική άδεια διευκόλυνσης', 'max_days': 5, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Ειδικής άδειας διευκόλυνσης', 'decision_text': 'υποψήφιο αιρετό εκπρόσωπο για το Περιφερειακό Υπηρεσιακό Συμβούλιο Διοικητικού Προσωπικού (ΠΥΣΔΥΠ) Δυτικής Ελλάδας, άδεια ειδική διευκόλυνσης', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Ειδική άδεια(θανάτου)', 'description': 'θανάτου', 'max_days': 3, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Ειδικής άδειας λόγω θανάτου συγγενούς', 'decision_text': 'ειδική άδεια λόγω θανάτου συγγενούς', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Εορταστική Άδεια', 'description': 'Εορταστική Άδεια', 'max_days': 2, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση εορταστικής άδειας', 'decision_text': 'εορταστική άδεια', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Κανονική Άδεια', 'description': '', 'max_days': 30, 'requires_approval': True, 'is_active': True, 'subject_text': '', 'decision_text': '', 'folder': '', 'general_category': '', 'affects_regular_leave_balance': True},
            {'name': 'Μονογονεϊκή Άδεια', 'description': 'Μονογονεϊκή Άδεια', 'max_days': 6, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Μονογονεϊκής Άδειας', 'decision_text': 'μονογονεϊκή άδεια', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Πατρότητας', 'description': 'Πατρότητας (Ν.4808/2021)', 'max_days': 14, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση Άδειας Πατρότητας (Ν.4808/2021)', 'decision_text': 'Άδεια Πατρότητας (Ν.4808/2021)', 'folder': 'Φ 12.5/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
            {'name': 'Συνδικαλιστική Άδεια', 'description': 'Συνδικαλιστική Άδεια', 'max_days': 10, 'requires_approval': True, 'is_active': True, 'subject_text': 'Χορήγηση συνδικαλιστικής άδεια', 'decision_text': 'συνδικαλιστική άδεια', 'folder': 'Φ 12.4/', 'general_category': 'Άλλες Άδειες', 'affects_regular_leave_balance': False},
