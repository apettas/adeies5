...
Ηλ. Ταχυδρομείο : pdede@sch.gr''',
    ...
    def load_leave_types(self):
        ...
        leave_types_data = [
            ...
            {'name': '2α Αναρρωτική Άδεια με ΥΔ', 'description': 'Αναρρωτική Άδεια με ΥΔ', 'max_days': 15, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False},
