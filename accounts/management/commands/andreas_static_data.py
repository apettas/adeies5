...
Ηλ. Ταχυδρομείο : pdede@sch.gr''',
    ...
    def load_leave_types(self):
        ...
        leave_types_data = [
            ...
            {'name': '2α Αναρρωτική Άδεια με ΥΔ', 'description': 'Αναρρωτική Άδεια με ΥΔ', 'max_days': 15, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False, 'is_sick_leave_yd': True},
            {'name': '2β Αναρρωτική Άδεια με Ιατρική Γνωμάτευση', 'description': 'Αναρρωτική Άδεια με Ιατρική Γνωμάτευση', 'max_days': 20, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False},
            {'name': '2γ Αναρρωτική Άδεια με απόφ. Υγειονομικής Επιτροπής', 'description': 'Αναρρωτική Άδεια με απόφ. Υγειονομικής Επιτροπής', 'max_days': 30, 'requires_approval': False, 'is_active': True, 'subject_text': 'Χορήγηση αναρρωτικής άδειας', 'decision_text': 'αναρρωτική άδεια', 'folder': 'Φ 12.2/', 'general_category': 'Αναρρωτικές Άδειες', 'affects_regular_leave_balance': False},
