...
Μπορείτε πλέον να συνδεθείτε στο σύστημα μέσω ΠΣΔ (Σχολικό Δίκτυο): https://sadeies.pdede.gov.gr/login/
...
def set_sadeies_login_url(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('accounts', '0048_registration_email_adeies_login_url'),
    ]

    operations = [
        migrations.RunPython(set_sadeies_login_url, noop_reverse),
    ]
